...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValidateRes) DeepCopyInto(out *ValidateRes) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValidateRes.
func (in *ValidateRes) DeepCopy() *ValidateRes {
	if in == nil {
		return nil
	}
	out := new(ValidateRes)
