...
func main() {
	...
	if err = (&konfiguratorv1alpha1.KonfiguratorTemplate{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "KonfiguratorTemplate")
		os.Exit(1)
	}
